...
let userText = null;
const API_KEY = "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";
const initialHeight = chatInput.scrollHeight;

// sayfa yüklendiğinde yerel depodan(localStorage) veri aktarır
const loadDataFromLocalStorage = () => {
  // tema rengini kontrol eder ve geçerli temayı uygular
  const themeColor = localStorage.getItem("theme-color");
  document.body.classList.toggle("light-mode", themeColor === "light_mode");
  // tema rengini yerel depoda güncelleme yapar
...
const showTypingAnimation = () => {
  const html = `
    ...
    <div class="chat-details">
      <img src="images/chat-gpt.jpg" alt="chat-images" />
